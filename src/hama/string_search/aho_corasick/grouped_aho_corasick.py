...
class AhoCorasickAutomaton:
    ...
    def add_words(self, words):
        ...
        Args:
            words (list): List of words. Each word is a list of either a character 
                          or a list of characters (match group) as an element.
        """
        for word in words:
            self.add_word(word)
    ...
    def add_word(self, word):
        ...
        Args:
            word (list): A word is a list of either a character 
                         or a list of characters (match group) as an element.
        """
